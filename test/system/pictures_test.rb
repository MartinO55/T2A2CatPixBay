...
class PicturesTest < ApplicationSystemTestCase
  ...
  test "creating a Picture" do
    ...
    fill_in "Non fungible token", with: @picture.non_fungible_token
    fill_in "Picture title", with: @picture.picture_title
    fill_in "Picture url", with: @picture.picture_url
